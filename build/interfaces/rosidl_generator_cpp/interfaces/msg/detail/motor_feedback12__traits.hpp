...
#ifndef INTERFACES__MSG__DETAIL__MOTOR_FEEDBACK12__TRAITS_HPP_
#define INTERFACES__MSG__DETAIL__MOTOR_FEEDBACK12__TRAITS_HPP_
...
// Member 'rr_thigh'
// Member 'rr_calf'
#include "interfaces/msg/detail/motor_feedback__traits.hpp"
...
inline std::string to_yaml(const MotorFeedback12 & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const interfaces::msg::MotorFeedback12 & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const interfaces::msg::MotorFeedback12 & msg)
{
  return interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<interfaces::msg::MotorFeedback12>()
{
  return "interfaces::msg::MotorFeedback12";
}

template<>
inline const char * name<interfaces::msg::MotorFeedback12>()
{
  return "interfaces/msg/MotorFeedback12";
}

template<>
struct has_fixed_size<interfaces::msg::MotorFeedback12>
  : std::integral_constant<bool, has_fixed_size<interfaces::msg::MotorFeedback>::value && has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<interfaces::msg::MotorFeedback12>
  : std::integral_constant<bool, has_bounded_size<interfaces::msg::MotorFeedback>::value && has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<interfaces::msg::MotorFeedback12>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // INTERFACES__MSG__DETAIL__MOTOR_FEEDBACK12__TRAITS_HPP_
