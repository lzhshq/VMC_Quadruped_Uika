...
#include "interfaces/msg/detail/motor_feedback12__rosidl_typesupport_fastrtps_c.h"
...
#include "interfaces/msg/detail/motor_feedback__functions.h"  // fl_calf, fl_hip, fl_thigh, fr_calf, fr_hip, fr_thigh, rl_calf, rl_hip, rl_thigh, rr_calf, rr_hip, rr_thigh
...
using _MotorFeedback12__ros_msg_type = interfaces__msg__MotorFeedback12;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MotorFeedback12__ros_msg_type * ros_message = static_cast<const _MotorFeedback12__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: fl_hip
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, interfaces, msg, MotorFeedback
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _MotorFeedback12__ros_msg_type * ros_message = static_cast<_MotorFeedback12__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_interfaces__msg__MotorFeedback12(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MotorFeedback12__ros_msg_type * ros_message = static_cast<const _MotorFeedback12__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_interfaces__msg__MotorFeedback(
...
static uint32_t _MotorFeedback12__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__MotorFeedback12(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__msg__MotorFeedback12(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: fl_hip
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_interfaces__msg__MotorFeedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = interfaces__msg__MotorFeedback12;
    is_plain =
      (
...
static size_t _MotorFeedback12__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__msg__MotorFeedback12(
...
static message_type_support_callbacks_t __callbacks_MotorFeedback12 = {
  "interfaces::msg",
  "MotorFeedback12",
...
static rosidl_message_type_support_t _MotorFeedback12__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MotorFeedback12,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, msg, MotorFeedback12)() {
  return &_MotorFeedback12__type_support;
}
