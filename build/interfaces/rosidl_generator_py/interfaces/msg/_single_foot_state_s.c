...
bool interfaces__msg__single_foot_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._single_foot_state.SingleFootState", full_classname_dest, 49) == 0);
  }
  interfaces__msg__SingleFootState * ros_message = _ros_message;
  {  // position
...
{
  /* NOTE(esteve): Call constructor of SingleFootState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._single_foot_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SingleFootState");
