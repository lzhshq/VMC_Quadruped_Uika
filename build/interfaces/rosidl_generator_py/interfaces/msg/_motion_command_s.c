...
bool interfaces__msg__motion_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._motion_command.MotionCommand", full_classname_dest, 44) == 0);
  }
  interfaces__msg__MotionCommand * ros_message = _ros_message;
  {  // header
  ...
  {  // body_height
    ...
    assert(PyFloat_Check(field));
    ros_message->body_height = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * interfaces__msg__motion_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._motion_command");
