...
bool interfaces__msg__base_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._base_state.BaseState", full_classname_dest, 36) == 0);
  }
  interfaces__msg__BaseState * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of BaseState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._base_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BaseState");
